...
export const PersonalSteps = {
  ...
  copy: [
    ...
    `*Examine the primary source(s)*. Is that source biased? Does the story accurately reflect the source? Instead of reading a story about a speech, watch the speech itself and form your own opinion.`,
    '*Balance your media diet* to gain a broader perspective and discover alternate views of the same event(s).',
  ],
};

/* Recommended Diet is shown here */

/* Ending is shown here */